...
def update_fast_components(n, coin_symbol, currency, timeframe):
    data = get_data_from_redis()
...
def update_trendline_visibility(chart_data_store, currency, selected_trends, coin_symbol):
    ...
    # Live/Status-prick (Neongrön för live, blå för övriga - Storlek justerad till 3 (25% av tidigare))
    if times and prices:
        ...
        figure.add_trace(go.Scatter(
            ...
            mode='markers',
            name='Nuvarande',
            marker=dict(color=point_color, size=3, line=dict(color='black', width=1))
        ))
